...
cmd:option('-use_checklist_plus', true, 'Use checklist+ model') --was false originally
cmd:option('-data_file_info', 'notco.', 'Data file name information')
cmd:option('-max_length', 200, '')
cmd:option('-use_sampling', false, 'Use sampling during beam search')
cmd:option('-temperature', 1, '')
cmd:option('-verbose', true, '') --was false originally
